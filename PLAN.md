...
- Promotion: a pawn ghost reaching the last rank promotes *that ghost* (player picks the piece). If a contact move stops short of the promotion square, no promotion happens.
